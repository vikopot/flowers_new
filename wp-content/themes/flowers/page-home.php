...
<!--      </script> -->
      ...
      <!-- <script>!function(f,b,e,v,n,t,s){if(f.fbq)return;n=f.fbq=function(){n.callMethod?
         ...
         fbq('init', '755297787996624', {}, {
             "agent": "woocommerce-3.4.2-1.7.5"
         });
                     ...
                     <aside id="nav_menu-5" class="widget widget_nav_menu">
                        <div class="menu-topbar-menu-container">
                           <ul id="menu-topbar-menu" class="menu">
                              <li id="menu-item-2562" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2562"><a href="/handmade/my-account/">Время работы с 9:00 до 20:00</a></li>
               ...
               <div class="container">
                  <div class="fl">
                     <div class="header-customize header-customize-left">
                        ...
                        <ul class="header-customize-item header-social-profile-wrapper" style="font-size: 22px">
                           ...
                           <li><a href="#" target="_blank"><i class="fab fa-facebook" style="color: #999;"></i></a></li>
                           <li><a href="#" target="_blank"><i class="fab fa-instagram" style="color: #999;"></i></a></li>
                  ...
                  <div class="fr">
                     <div class="header-customize header-customize-right header-customize-separate">
                        <div class="custom-text-wrapper header-customize-item">
                           <div class="contact-info"> <i class="fas fa-phone"></i>+ 38(094) 949 68 88</div>
                        </div>
                        ...
                        <div class="row">
                           <div class="col-md-6 sidebar text-left">
                              <aside id="text-3" class="copyright margin-top-10 widget widget_text">
                                 <div class="textwidget">
                                    <div>© Copyright 2017. Powered by WordPress.</div>
