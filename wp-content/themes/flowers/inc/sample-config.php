...
//    'desc'             => __( 'For full documentation on this field, visit: ', 'redux-framework-demo' ) . '<a href="//docs.reduxframework.com/core/fields/checkbox/" target="_blank">docs.reduxframework.com/core/fields/checkbox/</a>',
    'fields'           => array(
        ...
        array(
            ...
            'title'    => __( 'слоган', 'redux-framework-demo' ),
            'subtitle' => __( 'Subtitle', 'redux-framework-demo' ),
            'desc'     => __( 'Доставка цветов по всей Одессе. Любовь и забота о клиенте в каждом букете.', 'redux-framework-demo' ),
            'default'  => 'Доставка цветов по всей Одессе. Любовь и забота о клиенте в каждом букете.',
        ),
        array(
            'id'       => 'footer_contacts_siti-steet',
            'type'     => 'text',
            'title'    => __( 'Контакты(город, улица)', 'redux-framework-demo' ),
            'subtitle' => __( 'Subtitle', 'redux-framework-demo' ),
            'desc'     => __( 'Одесса, Пушкина 89', 'redux-framework-demo' ),
            'default'  => 'Одесса, Пушкина 89',
        ),
        array(
            'id'       => 'footer_contacts_email',
            'type'     => 'text',
            'title'    => __( 'Контакты(email)', 'redux-framework-demo' ),
            'subtitle' => __( 'Subtitle', 'redux-framework-demo' ),
            'desc'     => __( 'flowers@gmail.com', 'redux-framework-demo' ),
            'default'  => 'flowers@gmail.com',
        ),
        array(
            'id'       => 'footer_contacts_phone',
            'type'     => 'text',
            'title'    => __( 'Контакты(телефон)', 'redux-framework-demo' ),
            'subtitle' => __( 'Subtitle', 'redux-framework-demo' ),
            'desc'     => __( '+ 38(094) 949 68 88', 'redux-framework-demo' ),
            'default'  => '+ 38(094) 949 68 88',
        ),
        array(
            'id'       => 'footer_copyright',
            ...
            'subtitle' => __( 'Subtitle', 'redux-framework-demo' ),
            'desc'     => __( 'Copyright 2018. Love Roses .', 'redux-framework-demo' ),
            'default'  => 'Copyright 2018. Love Roses .',
        ),
    )
) );
//
