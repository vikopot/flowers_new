...
class WPF_Public {
    ...
    public function result_container($content = '') {
        ...
        if (is_woocommerce()) {
            echo '<div data-slug="' . $slug . '" class="wpf-search-container row">';
        } else {
    ...
    public function get_result(array $data, array $form) {
        ...
        return '<div class="wpf-search-wait"></div><!--обвертка для названия ,кол-ва,сотрировка--><div class="container">' . $result . '</div>';
    }
